...
CONCURRENCY_LIMITS = {
    "openrouter": int(os.getenv("OPENROUTER_CONCURRENCY", "10")),
    "fireworks": int(os.getenv("FIREWORKS_CONCURRENCY", "8")),
    "openai": int(os.getenv("OPENAI_CONCURRENCY", "12")),
    "default": int(os.getenv("DEFAULT_CONCURRENCY", "6")),
}
