"""Reviewer feedback: overall comment + per-section comments, appreciations, likes, overall score."""
...
class ReviewerFeedback(BaseModel):
    ...
    # Numeric quality score: 1=bad, 2=poor, 3=good, 4=very good, 5=perfect
    overall_score: Optional[int] = Field(
        None,
        ge=1,
        le=5,
        description="Overall quality score: 1=bad, 2=poor, 3=good, 4=very good, 5=perfect",
    )
    ...
    prompt_feedback: str = Field("", description="Reviewer feedback for Prompt section (shown when prompt is locked)")
    model_reference_feedback: str = Field("", description="Reviewer feedback for Model Reference section (shown when locked)")
    judge_system_prompt_feedback: str = Field("", description="Reviewer feedback for Judge System Prompt section (shown when locked)")
