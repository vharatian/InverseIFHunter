...
def _build_display_snapshot(session_dict: Dict[str, Any]) -> Dict[str, Any]:
    ...
    ideal_response = notebook.get("response", "")  # Trainer-written expected response
    ...
    # response_reference contains the criteria rubric (C1: ..., C2: ...), not an ideal answer.
    # Extract structured criteria from it; leave reference empty (no separate ideal response field exists).
