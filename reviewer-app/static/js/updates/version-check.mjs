/**
 * Shared version polling + update UX (reviewer copy).
 * Keep in sync with static/js/updates/version-check.mjs — duplicated so subpath
 * deployments (/staging/reviewer/) resolve imports under reviewer static, not /static/.
 */
