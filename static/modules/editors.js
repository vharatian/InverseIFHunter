...
export function initStructuredInput() {
    ...
    elements.modelrefPreview.addEventListener('input', () => {
        ...
        state.referenceValidated = false; // Criteria changed — must re-judge
...
/**
 * Populate Evaluation Model (judge) dropdown from config (global.yaml hunt.judge_models) and enable it.
 */
