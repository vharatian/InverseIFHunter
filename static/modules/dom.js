...
export const elements = {
    ...
    proceedToQCBtn: document.getElementById('proceedToQCBtn'),
    submitColabBtn: document.getElementById('submitColabBtn'),
    ...
    selectionSectionCard: document.getElementById('selectionSectionCard'),
    selectionSectionCardHeader: document.getElementById('selectionSectionCardHeader'),
    selectionSectionCardBody: document.getElementById('selectionSectionCardBody'),
    selectionSectionCollapsedSummary: document.getElementById('selectionSectionCollapsedSummary'),
